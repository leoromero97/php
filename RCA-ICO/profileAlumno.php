...
<body>
	...
	<div class="container">
		<div class="content">
			...
			<a href="editAlumno.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" center>
				<img src="img/ic_edit.svg" alt="Editar icono" class="mr-4" />
				Editar datos
			</a>
			<a href="profileAlumno.php?aksi=delete&id=<?php echo $row['id']; ?>" class="btn btn-danger center" onclick="return confirm('¿Estás seguro de borrar los datos de <?php echo $row['nombre']; ?> ?')">
