...
<head>
  ...
  <meta name="author" content="Leonardo G. Romero ">
	...
	<title>RCA - ICO | Vista de Cursos</title>
          ...
          <th>ID</th>
				...
				if(mysqli_num_rows($sql) == 0){
					...
					while($row = mysqli_fetch_assoc($sql)){
						echo '
						<tr>
							<td><a href="profileCursoA.php?id='.$row['id'].'"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>'.$row['id'].'</a></td>
							<td>'.$row['curso'].'</td>
						</tr>';
						$no++;
					}
