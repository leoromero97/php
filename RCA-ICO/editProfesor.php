...
<head>
  ...
  <meta name="author" content="Leonardo G. Romero ">
	...
	<title>RCA - ICO | Editar datos del profesor</title>
...
<body>
	...
	<div class="container">
		<div class="content">
			<h1 class="titulo1">Datos del profesor &raquo; Editar</h1>
			<hr />
			<?php
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($con, "UPDATE profesores SET apellido='$apellido', nombre='$nombre', dni='$dni', telefono='$telefono' WHERE id='$id'") or die(mysqli_error());
				if($update){
					header("Location: editProfesor.php?id=".$id."&pesan=sukses");
				}else{
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="number" name="dni" value="<?php echo $row ['dni']; ?>" class="form-control" placeholder="DNI" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Teléfono</label>
					<div class="col-sm-3">
					<input type="number" name="telefono" value="<?php echo $row ['telefono']; ?>" class="form-control" placeholder="Telefono" required>
					</div>
				</div>
				<div class="form-group">
