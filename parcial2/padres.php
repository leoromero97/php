...
<head>
  ...
  <script src="js/scriptPadres.js"></script>
...
<body>
	<div>
    <div id="buscadorPadres"></div>
    <div class="contenedorTablaProfesores">
      <div id="tablaPadres" class="tableProfesores"></div>
    </div>
	</div>

	<!-- Modal para registros nuevos de padres-->
<div class="modal fade" id="modalNuevo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Agrega nuevo padre</h4>
      </div>
      <div class="modal-body">
          ...
          <label>Número de documento</label>
        	<input type="text" name="" id="numero_documento" class="form-control input-sm">
          ...
          <label>Cantidad de hijos</label>
        	<input type="number" name="" id="cantidad_hijos" class="form-control input-sm">
      </div>
...
<div class="modal fade" id="modalEdicion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Actualizar datos del padre</h4>
      </div>
      <div class="modal-body">    
          ...
          <label>Cantidad de hijos</label>
        	<input type="text" name="" id="cantidad_hijosU" class="form-control input-sm">
      </div>
      <div class="modal-footer">
...
<script type="text/javascript">
    $(document).ready(function(){
      $('#guardarnuevo').click(function(){
        ...
        mail=$('#mail').val();
        cantidad_hijos=$('#cantidad_hijos').val();
          agregardatos(nombre,apellido,tipo_documento,numero_documento,domicilio,telefono,mail,cantidad_hijos);
      });
