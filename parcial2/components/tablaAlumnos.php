...
<div class="row">
	<div class="col-sm-12">
  <h2 class="titulo1 margen-inferior2">Tabla de alumnos</h2>
		...
		<caption>
	  	<button class="boton-primario margen-inferior2" data-toggle="modal" data-target="#modalNuevo">
			...
			<tr>
        <td class="tituloTabla">Legajo</td>
        ...
        <td class="tituloTabla">Editar</td>
			...
			<?php 
				if(isset($_SESSION['consulta'])){
					if($_SESSION['consulta'] > 0){
						...
						$sql="SELECT legajo,nombre,apellido,tipo_documento,numero_documento,domicilio,telefono,mail,nivel 
						from alumnos where legajo='$idp'";
					}else{
						$sql="SELECT legajo,nombre,apellido,tipo_documento,numero_documento,domicilio,telefono,mail,nivel 
						from alumnos";
					}
			...
			<tr>
				<td class="textoTabla"><?php echo $ver[0] ?></td>
